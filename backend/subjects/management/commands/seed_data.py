    ...
    def _create_subjects(self):
        ...
        subjects_data = [
            {
                ...
                'ent_question_count': 20, 'ent_max_score': 20, 'ent_threshold': 5,
            ...
            },
            {
                ...
                'ent_question_count': 10, 'ent_max_score': 10, 'ent_threshold': 3,
        ...
        for s in subjects_data:
            ...
            defaults = {
                ...
                'ent_question_count': s.get('ent_question_count', 40),
                'ent_max_score': s.get('ent_max_score', 50),
                'ent_threshold': s.get('ent_threshold', 5),
            }
            if 'is_visible' in s:
